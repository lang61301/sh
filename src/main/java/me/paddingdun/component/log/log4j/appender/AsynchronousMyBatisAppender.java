package me.paddingdun.component.log.log4j.appender;
...
public class AsynchronousMyBatisAppender extends AppenderSkeleton implements Appender, Runnable {
	 ...
	 * #registerWithLoggers.}
	 */
	private String[] loggers = new String[]{ILogConstant.CATEGORY_NAME};
	/**
	 * The event queue.
	 */
...
//				Session session = getSessionFactory().openSession();
				try {
					...
					logError("Exception", he, ErrorCode.GENERIC_FAILURE);
				} finally {
